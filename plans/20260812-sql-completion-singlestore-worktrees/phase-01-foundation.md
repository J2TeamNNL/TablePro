...
- Status: implemented, verification blocked by local Xcode toolchain
- Priority: P1
...
- [ ] Tạo `QueryCompletionProfile`
- [ ] Thêm API resolve profile vào PluginKit
- [ ] Dựng registry + conservative fallback
- [ ] Scope cache theo query tab
- [ ] Truyền `scope/serverVersion/profileRevision` tới editor
- [ ] Đổi precedence metadata lookup
- [ ] Viết test 2-tab và fallback version
- [ ] Chạy build/lint/ABI check
