---
title: Introduction
description: Native macOS database client for MySQL, PostgreSQL, SQLite, MongoDB, Redis, and 23 more
---
...
Twenty-eight engines, from MySQL and PostgreSQL to DynamoDB, Spanner and Redis, each with its own
