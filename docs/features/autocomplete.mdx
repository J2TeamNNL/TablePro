...
Where the hierarchy is database, schema, table (Snowflake, BigQuery, Spanner), every segment completes and a schema you have not opened in the sidebar is fetched on demand:
