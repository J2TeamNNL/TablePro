...
View tables and foreign key relationships as an interactive diagram. Right-click a database in the sidebar and select **View ER Diagram**, or use the menu bar **View > ER Diagram**, to open the full schema diagram. Right-click a table and select **View ER Diagram** to open a focused diagram for that table and its directly related tables.
