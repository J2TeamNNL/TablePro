...
description: All 32 engines TablePro connects to, their default ports, and which ones need a plugin
---

import DriverCounts from "/snippets/driver-counts.mdx";

Thirty-two engines, and every one of them is free to use. What differs between them is where the
...
Rows sharing a page share a driver. MariaDB, TiDB and Databend read as MySQL, ScyllaDB as Cassandra,
