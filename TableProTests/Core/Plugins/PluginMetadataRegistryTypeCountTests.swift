...
///
/// The answer is 32, and the reason it once read 28 is worth keeping. Turso is served by
...
/// Both answer 32 under XCTest, where no plugin bundle ever loads, but the registry is a
...
struct PluginMetadataRegistryTypeCountTests {
    private static let expectedTypeIds: Set<String> = [
        ...
        "Dameng", "Databend", "DuckDB", "DynamoDB", "Elasticsearch", "etcd", "Kafka", "libSQL",
        "MariaDB", "MongoDB", "MySQL", "Oracle", "PGlite", "PostgreSQL", "Redis", "Redshift",
        "ScyllaDB", "Snowflake", "SQL Server", "SQLite", "SurrealDB", "Teradata", "TiDB",
        "Trino", "Turso", "Typesense"
    ]
    ...
    @Test("The app ships 32 database types before any plugin loads")
